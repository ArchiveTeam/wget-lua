...
static struct {
  ...
  { TAG_DIV,            "src",            ATTR_HTML },
  { TAG_DIV,            "data-src",       ATTR_HTML },
  { TAG_DIV,            "data-uri",       ATTR_HTML },
  { TAG_DIV,            "data-url",       ATTR_HTML },
  { TAG_DIV,            "data-href",      ATTR_HTML },
  { TAG_DIV,            "data-image-url", ATTR_INLINE },
  { TAG_DIV,            "data-card-url",  ATTR_HTML },
  { TAG_SPAN,           "src",            ATTR_HTML },
  { TAG_SPAN,           "data-src",       ATTR_HTML },
  { TAG_SPAN,           "data-uri",       ATTR_HTML },
  { TAG_SPAN,           "data-href",      ATTR_HTML },
  { TAG_LI,             "src",            ATTR_HTML },
  { TAG_LI,             "data-src",       ATTR_HTML },
  { TAG_LI,             "data-uri",       ATTR_HTML },
...
static struct {
  ...
  { TAG_META,       "name",         "twitter:url",              "content",  ATTR_HTML | ATTR_IGNORE },
